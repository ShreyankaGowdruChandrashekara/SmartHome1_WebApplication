...
// 	/* Trending Page Displays all the Voices and their Information in Game Speed */
...
// 	/* Checks the Voices type whether it is microsft or apple or samsung */
...
// 		All the voices and voice information are dispalyed in the Content Section
...
// 		pw.print("<a style='font-size: 24px;'>" + name + " Voices</a>");
...
// 			pw.print("<li id='item'><img src='images/voices/"
