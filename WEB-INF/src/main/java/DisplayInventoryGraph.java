...
public class DisplayInventoryGraph extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
        ...
        out.print("<article> <h1 align=\"center\"><span style='color:brown;'>"+"Product Inventory Display</span></h1> ");
        ...
        out.print("<div id=\"inventory_barchart\" style=\"width:700px; height:1000px;background-color:lightbrown;\"></div>");
